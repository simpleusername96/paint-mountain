...
- Replay format 4 stores stage/profile versions, accepted seed plus height,
  ...
  only replay-origin actions; format 3 is rejected because terrain, paint, and
  observation semantics changed.
...
contact, closed-terrain, manual-aim, mechanism-body, replay-format-4, or rebuilt-UI
contracts above.
