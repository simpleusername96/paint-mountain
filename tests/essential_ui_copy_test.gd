...
func _run_checks() -> void:
	...
	_assert_present(settings, [
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/MasterGroup/Header/Icon",
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/MasterGroup/Header/MasterValue",
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/MasterGroup/Master",
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/MusicGroup/Header/MusicValue",
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/SfxGroup/Header/SfxValue",
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/CameraRow/Icon",
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/CameraRow/CameraShake",
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/MotionRow/Icon",
		"SettingsRoot/Panel/Margin/Content/Columns/Layout/Audio/TrajectoryRow/Icon",
