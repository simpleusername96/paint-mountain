...
func _run_checks() -> void:
	...
	recorder.record_shot(1, -12.0, 39.0, 72.0)
	recorder.record_shot(2, 3.0, 44.0, 76.0)
	recorder.record_event(&"mechanism_activated", {"kind": "SPLITTER"})
	...
	_assert_true(replay_observation.actions.size() == 2, "replay must preserve ordered shot inputs")
