...
func record_ball_fire(shot_id: int, ball_kind: int, paint_channel: int) -> bool:
	return _observation.record_ball_fire(shot_id, ball_kind, paint_channel)
